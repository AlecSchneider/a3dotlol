...
export const metadata = {
  title: "The Project | a3.lol",
  description: "Background and goals behind a3.lol",
};
        ...
        <section className="mt-10 space-y-6">
          <article className="border border-[var(--surface-border)] bg-[var(--surface)] px-5 py-5">
            <p className="text-sm leading-7 text-[var(--text-subtle)]">
              I&apos;ve worked in tech for the last 10 years, including before AI
              and vibe coding. I started my journey at Uber in San Francisco as
              an intern, then spent the next 6 years at Palantir in New York
              City.
            </p>
            ...
            <p className="mt-4 text-sm leading-7 text-[var(--text-subtle)]">
              On this website and on YouTube in my live stream, I am
              challenging myself to make 100.000 Euros from vibe-coded apps. I
              started with the first project of building this website, and now I
              will build more and more projects to start generating revenue.
            </p>
            <p className="mt-4 text-sm leading-7 text-[var(--text-subtle)]">
